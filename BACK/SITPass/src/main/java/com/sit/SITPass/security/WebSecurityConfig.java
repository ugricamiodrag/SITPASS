    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/users/login", "/api/users/register", "/api/facilities/search", "/api/comments", "/api/search/simple", "/api/search/advance", "/api/index/**", "/api/search/mlt").permitAll()
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web
                ...
                .requestMatchers(HttpMethod.POST, "/api/users/login", "/api/comments", "/api/users/email", "/api/facilities/unvisited", "/api/analytics/reviews",
                        "api/analytics/custom", "/api/analytics/users", "/api/search/simple", "/api/search/advance", "/api/index/**", "/api/search/mlt")
